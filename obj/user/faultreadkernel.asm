	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80024d:	0f be 84 03 85 ee ff 	movsbl -0x117b(%ebx,%eax,1),%eax
  800254:	ff 
  800255:	50                   	push   %eax
...
0080029d <vprintfmt>:
{
  ...
  800329:	03 b4 81 14 ef ff ff 	add    -0x10ec(%ecx,%eax,4),%esi
...
008003ec <.L28>:
  ...
  800411:	8d 80 a6 ee ff ff    	lea    -0x115a(%eax),%eax
  800417:	50                   	push   %eax
  800418:	57                   	push   %edi
  800419:	56                   	push   %esi
  ...
  80042e:	8d 80 9d ee ff ff    	lea    -0x1163(%eax),%eax
  800434:	50                   	push   %eax
  800435:	57                   	push   %edi
  800436:	56                   	push   %esi
...
00800447 <.L24>:
  ...
  80045d:	8d 80 96 ee ff ff    	lea    -0x116a(%eax),%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b82:	8d 83 6c f0 ff ff    	lea    -0xf94(%ebx),%eax
  800b88:	50                   	push   %eax
  800b89:	6a 23                	push   $0x23
  800b8b:	8d 83 89 f0 ff ff    	lea    -0xf77(%ebx),%eax
  800b91:	50                   	push   %eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800be3:	57                   	push   %edi
  800be4:	50                   	push   %eax
  800be5:	8d 83 98 f0 ff ff    	lea    -0xf68(%ebx),%eax
  800beb:	50                   	push   %eax
  ...
  800bf8:	e8 32 f5 ff ff       	call   80012f <vcprintf>
	cprintf("\n");
  800bfd:	8d 83 bb f0 ff ff    	lea    -0xf45(%ebx),%eax
